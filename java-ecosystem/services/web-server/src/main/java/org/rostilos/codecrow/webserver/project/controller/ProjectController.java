...
public class ProjectController {
        ...
        public ResponseEntity<Map<String, String>> generateProjectJwt(
                        ...
                        @RequestBody CreateProjectTokenRequest request) throws GeneralSecurityException {
                Workspace workspace = workspaceService.getWorkspaceBySlug(workspaceSlug);
        ...
        public ResponseEntity<List<ProjectTokenDTO>> listProjectTokens(
                ...
                Workspace workspace = workspaceService.getWorkspaceBySlug(workspaceSlug);
                Project project = projectService.getProjectByWorkspaceAndNamespace(workspace.getId(), projectNamespace);
                List<ProjectTokenDTO> tokens = projectTokenService.listTokens(workspace.getId(), project.getId())
                                .stream()
        ...
        public ResponseEntity<HttpStatus> updateRepositorySettings(
                        @PathVariable String workspaceSlug,
                        @PathVariable String projectNamespace,
                        @RequestBody UpdateRepositorySettingsRequest request) throws GeneralSecurityException {
                Workspace workspace = workspaceService.getWorkspaceBySlug(workspaceSlug);
                Project project = projectService.getProjectByWorkspaceAndNamespace(workspace.getId(), projectNamespace);
        ...
        public ResponseEntity<List<BranchDTO>> getProjectBranches(
                        ...
                        @PathVariable String projectNamespace) {
                Workspace workspace = workspaceService.getWorkspaceBySlug(workspaceSlug);
                List<org.rostilos.codecrow.core.model.branch.Branch> branches = projectService
                                .getProjectBranches(workspace.getId(), projectNamespace);
        ...
        public ResponseEntity<ProjectDTO> setDefaultBranch(
                ...
                if (request.branchId() != null) {
                        project = projectService.setDefaultBranch(workspace.getId(), projectNamespace,
                                        request.branchId());
                } else if (request.branchName() != null && !request.branchName().isBlank()) {
                        project = projectService.setDefaultBranchByName(workspace.getId(), projectNamespace,
                                        request.branchName());
                } else {
        ...
        /**
         * GET
         * /api/workspace/{workspaceSlug}/project/{projectNamespace}/branch-analysis-config
         ...
         * Request body: { "prTargetBranches": ["main", "develop", "release/*"],
        ...
        public ResponseEntity<RagStatusResponse> getRagIndexStatus(
                ...
                return new ResponseEntity<>(new RagStatusResponse(
                                ...
                                ragIndexStatusService.canStartIndexing(project)), HttpStatus.OK);
        }
         ...
         * Triggers RAG indexing for the project. Returns an SSE stream with progress
         * updates.
         * 
         * Security:
        ...
        /**
         * GET
         * /api/workspace/{workspaceSlug}/project/{projectNamespace}/comment-commands-config
        ...
        /**
         * Updates analysis settings for the project (PR auto-analysis, branch analysis,
         * installation method)
         */
                ...
                if (request.installationMethod() != null) {
                        try {
                                ...
                                throw new IllegalArgumentException(
                                                "Invalid installation method: " + request.installationMethod());
                        }
                }
        ...
        public ResponseEntity<WebhookSetupResponse> setupWebhooks(
                ...
                Workspace workspace = workspaceService.getWorkspaceBySlug(workspaceSlug);
                Project project = projectService.getProjectByWorkspaceAndNamespace(workspace.getId(), projectNamespace);
                ProjectService.WebhookSetupResult result = projectService.setupWebhooks(workspace.getId(),
                                project.getId());
                return new ResponseEntity<>(new WebhookSetupResponse(
                                result.success(),
                                result.webhookId(),
                                result.webhookUrl(),
                                result.message()), result.success() ? HttpStatus.OK : HttpStatus.BAD_REQUEST);
        }
        ...
        public ResponseEntity<WebhookInfoResponse> getWebhookInfo(
                ...
                return new ResponseEntity<>(new WebhookInfoResponse(
                                ...
                                info.webhookId(),
                                info.webhookUrl(),
                                info.provider() != null ? info.provider().name() : null), HttpStatus.OK);
        }
