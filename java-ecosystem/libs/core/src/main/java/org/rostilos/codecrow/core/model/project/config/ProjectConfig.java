...
/**
 * Project-level configuration stored as JSON in the project.configuration
 * column.
 *
 * Currently supports:
 * - useLocalMcp: when true, MCP servers should prefer local repository access
 * (LocalRepoClient)
...
public class ProjectConfig {
    ...
    public BranchAnalysisConfig branchAnalysis() {
    ...
    public Boolean prAnalysisEnabled() {
    ...
    public CommentCommandsConfig commentCommands() {
        return commentCommands;
    }

    public ProjectRulesConfig projectRules() {
        return projectRules;
    }
    ...
    public void setBranchAnalysis(BranchAnalysisConfig branchAnalysis) {
        this.branchAnalysis = branchAnalysis;
    }
    ...
    public void setCommentCommands(CommentCommandsConfig commentCommands) {
        this.commentCommands = commentCommands;
    }
    ...
    public void ensureMainBranchInPatterns() {
        ...
        if (this.branchAnalysis != null) {
            ...
            if (prNeedsUpdate || pushNeedsUpdate) {
                List<String> newPrTargets = prTargets != null ? new java.util.ArrayList<>(prTargets)
                        : new java.util.ArrayList<>();
                List<String> newPushPatterns = pushPatterns != null ? new java.util.ArrayList<>(pushPatterns)
                        : new java.util.ArrayList<>();
